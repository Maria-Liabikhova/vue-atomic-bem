      ...
      <div class="w-100 w-md-50">
        ...
        >
          <p class="mb-10 mb-lg-16 main__banner--text">
            ...
            subpar product; I know it is going to be good. That is the number
            one advantage of working with Exhibit Systems."
          </p>
      ...
      <div class="d-md-flex main__transform--threed">
        <div class="w-100 w-md-42">
          ...
          <p class="main__text mb-15 mb-lg-25">
            ...
            the original Star Trek show really did do a good job of capturing
            our feelings about space.
          </p>
